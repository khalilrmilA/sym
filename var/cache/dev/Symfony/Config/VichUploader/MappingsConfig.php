...
class MappingsConfig 
{
     ...
     */
    public function namer(mixed $value = []): \Symfony\Config\VichUploader\MappingsConfig\NamerConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function directoryNamer(mixed $value = []): \Symfony\Config\VichUploader\MappingsConfig\DirectoryNamerConfig|static
    {
        if (!\is_array($value)) {
