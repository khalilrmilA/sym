 ...
 */
class getReeclamationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReeclamationRepository' shared autowired service.
     *
     * @return \App\Repository\ReeclamationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReeclamationRepository.php';

        return $container->privates['App\\Repository\\ReeclamationRepository'] = new \App\Repository\ReeclamationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
